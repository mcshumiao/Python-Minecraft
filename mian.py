                    ...
                    for y in range(-1, gmap[x][z]):
                        if y < 2:
                            self.add_block((x, y, z), random.choice(
                                [STONE, STONE, STONE, DIMO, IRNO, COAL, IRNO, COAL, GOLDO, STONE, STONE, STONE]))
                        else:
        ...
        for x in range(0, BASELEN):
            for z in range(0, BASELEN):
                ...
                if gmap[x][z] < 2:
                    ...
                    for y in range(-1, gmap[x][z]):
                        if y < 2:
                            self._enqueue(self.add_block, (xx, y, zz), random.choice(
                                [STONE, STONE, STONE, DIMO, IRNO, COAL, IRNO, COAL, GOLDO, STONE, STONE, STONE]))
                        else:
                            if HAMPL > 16:
                                self._enqueue(self.add_block, (xx, y, zz),
                                              random.choice([STONE, STONE, STONE, COAL, STONE, STONE, STONE]))
                            else:
            ...
            if (x, z) not in self.model.areat:
                ...
                for i in range(-1, 2):
                    if self.model.areat[(x, z)] != 1:
                        break
                    for j in range(-1, 2):
                        if (x + i * BASELEN, z + j * BASELEN) in self.model.areat and self.model.areat[
                            (x + i * BASELEN, z + j * BASELEN)] == 2 and random.randint(0, 2) == 0:
                            self.model.areat[(x, z)] = 2
                            break
